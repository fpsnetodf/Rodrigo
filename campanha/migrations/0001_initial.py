...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo_recurso', models.CharField(choices=[('transporte', 'Transporte'), ('alimentacao', 'Alimentação'), ('material_grafico', 'Material Gráfico')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('coordenador', 'Coordenador'), ('lideranca', 'Liderança'), ('eleitor', 'Eleitor')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('criado_por', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='campanha.usuario')),
            ],
        ),
        migrations.CreateModel(
            name='Agenda',
